...
public class RecsAdapter extends RecyclerView.Adapter<RecsAdapter.MyViewHolder> {
    ...
    public RecsAdapter(Context mContext, List<Time> mData) {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        final Time time = mData.get(position);
        ...
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Users").child(time.getId());
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                holder.showscore.setText(""+time.getTime_string());
            }
